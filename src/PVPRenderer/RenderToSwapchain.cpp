...
namespace pvp
{
    RenderToSwapchain::RenderToSwapchain(Swapchain* swapchain)
        : m_swapchain{ swapchain }
    {
    }
    void RenderToSwapchain::draw(VkCommandBuffer cmd, Image& image_to_blit)
    {
        ...
        //     }
        //
        //     image_to_blit.transition_layout(cmd, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL);
        ...
        // Color transition
        {
            ...
            VkImageMemoryBarrier2 image_memory_barrier{
                ...
                .image = m_swapchain->get_images()[0],
        ...
        //         .srcImage = image_to_blit.get_image(),
        //         .srcImageLayout =,
        //         .dstImage = m_swapchain->get_images()[m_swapchain.],
        //         .dstImageLayout =,
        //         .regionCount = 1,
        //         .pRegions =,
